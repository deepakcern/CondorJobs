...
python monoHbbAnalyzer.py -y 2017 -F -i "$1"

if [ -e "$4" ]; then
  until xrdcp -f "$4" root://eoscms.cern.ch//eos/cms/store/group/phys_exotica/monoHiggs/monoHbb/2017_AnalyserOutput/perfilePUtest2/"$4"; do 
    sleep 60
    echo "Retrying"
  done
